...
COMMAND_EXAMPLES: list[CommandExample] = [
    ...
    CommandExample(ScopeNames.SHARE_SCREEN, "Share photo.", [ToolInvocation("get_qr", {})]),
    CommandExample(ScopeNames.SHARE_SCREEN, "Get the qr code.", [ToolInvocation("get_qr", {})]),
    CommandExample(ScopeNames.SHARE_SCREEN, "Zo grappig. Upload the photo.", [ToolInvocation("get_qr", {})]),
